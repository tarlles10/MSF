<?php 
	...
	$objEmpresa->atribuirInformeEmpresa($objConexao, $_GET["cod"]);
...
<table width="579" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="top_grupoMostraConteudo_mascoteEmpresa">
<!--
===============================================================================================================================
...
<table width="579" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td class="top_grupoRes_top_02" style="width: 286px;"><span class="adm_fonteResTop_01" style="font-size:16px;"><?php echo $objEmpresa->getTituloItem();?></span></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="457" height="70" align="left" valign="top">
                	<span class="adm_fonteFormGrupo_01" style="color: #999999;"><?php echo "Atualizado em ".$objEmpresa->getDt_publicacao();?></span>
                </td>
                <td width="170"></td>
              </tr>
              <tr>
              ...
              <tr>
              	<td></td>
                <td colspan="2" align="left" valign="top" class="adm_fonteTextoGrupo_01" id="descricaoTexto"><?php echo $objEmpresa->getDescricaoItem();?></td>
              </tr>
              <tr>
              	<td></td>
