...
// Images Directory
imagesDir 	= "../js/css/icons/";

// CSS Directory
cssDir 		= "../js/css/styles/";

// Popups Directory
popupsDir 	= "../js/css/popups/";
...
\* ---------------------------------------------------------------------- */
function generate_wysiwyg(textareaID, $bln_noFontes) 
{
	if ($bln_noFontes == undefined)
	{
		$bln_noFontes = true;
		ToolbarList['selectfont']	=  ['SelectFont',           'SelectFont',         imagesDir + 'select_fontDisable.gif',        imagesDir + 'select_fontDisable.gif'];
		ToolbarList['selectsize']	=  ['SelectSize',           'SelectSize',         imagesDir + 'select_sizeDisable.gif',        imagesDir + 'select_sizeDisable.gif'];
		ToolbarList['subscript']	=  ['Subscript',            'Subscript',          imagesDir + 'subscriptDisable.gif',          imagesDir + 'subscriptDisable.gif'];
		ToolbarList['justifyleft']	=  ['Justifyleft',          'Justifyleft',        imagesDir + 'justify_leftDisable.gif',       imagesDir + 'justify_leftDisable.gif'];
		ToolbarList['justifycenter']=  ['Justifycenter',        'Justifycenter',      imagesDir + 'justify_centerDisable.gif',     imagesDir + 'justify_centerDisable.gif'];
		ToolbarList['justifyright']	=  ['Justifyright',         'Justifyright',       imagesDir + 'justify_rightDisable.gif',      imagesDir + 'justify_rightDisable.gif'];
		ToolbarList['superscript']	=  ['Superscript',          'Superscript',        imagesDir + 'superscriptDisable.gif',        imagesDir + 'superscript_on.gif'];
		ToolbarList['unorderedlist']=  ['InsertUnorderedList',  'InsertUnorderedList',imagesDir + 'list_unorderedDisable.gif',     imagesDir + 'list_unorderedDisable.gif'];
		ToolbarList['orderedlist']	=  ['InsertOrderedList',    'InsertOrderedList',  imagesDir + 'list_orderedDisable.gif',       imagesDir + 'list_orderedDisable.gif'];
		ToolbarList['outdent']		=  ['Outdent',              'Outdent',            imagesDir + 'indent_leftDisable.gif',        imagesDir + 'indent_leftDisable.gif'];
		ToolbarList['indent']		=  ['Indent',               'Indent',             imagesDir + 'indent_rightDisable.gif',       imagesDir + 'indent_rightDisable.gif'];		
	}else if ($bln_noFontes == false)
	{
		ToolbarList['selectfont']	=  ['SelectFont',           'SelectFont',         imagesDir + 'select_font.gif',        imagesDir + 'select_font_on.gif'];
		ToolbarList['selectsize']	=  ['SelectSize',           'SelectSize',         imagesDir + 'select_size.gif',        imagesDir + 'select_size_on.gif'];
		ToolbarList['subscript']	=  ['Subscript',            'Subscript',          imagesDir + 'subscript.gif',          imagesDir + 'subscript_on.gif'];
		ToolbarList['justifyleft']	=  ['Justifyleft',          'Justifyleft',        imagesDir + 'justify_left.gif',       imagesDir + 'justify_left_on.gif'];
		ToolbarList['justifycenter']=  ['Justifycenter',        'Justifycenter',      imagesDir + 'justify_center.gif',     imagesDir + 'justify_center_on.gif'];
		ToolbarList['justifyright']	=  ['Justifyright',         'Justifyright',       imagesDir + 'justify_right.gif',      imagesDir + 'justify_right_on.gif'];		
		ToolbarList['superscript']	=  ['Superscript',          'Superscript',        imagesDir + 'superscript.gif',        imagesDir + 'superscript_on.gif'];
		ToolbarList['unorderedlist']=  ['InsertUnorderedList',  'InsertUnorderedList',imagesDir + 'list_unordered.gif',     imagesDir + 'list_unordered_on.gif'];
		ToolbarList['orderedlist']	=  ['InsertOrderedList',    'InsertOrderedList',  imagesDir + 'list_ordered.gif',       imagesDir + 'list_ordered_on.gif'];
		ToolbarList['outdent']		=  ['Outdent',              'Outdent',            imagesDir + 'indent_left.gif',        imagesDir + 'indent_left_on.gif'];
		ToolbarList['indent']		=  ['Indent',               'Indent',             imagesDir + 'indent_right.gif',       imagesDir + 'indent_right_on.gif'];		
	}
  // Hide the textarea 
  ...
  // Generate WYSIWYG toolbar one
  	var toolbar;
  	toolbar =  '<table id="TabelaEditor1" cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
	...
	{ 
		if (buttonName[i]) 
		{
			...
			{
				$condicionalSentinela = (buttonImage!='../js/editor/icons/bold.gif' && buttonImage!='../js/editor/icons/italics.gif' && buttonImage!='../js/editor/icons/underline.gif');
				if ($bln_noFontes && $condicionalSentinela)
				{
					toolbar += '<td style="width: 22px;"><img src="' +buttonImage+ '" border=0 unselectable="on" title="' +buttonTitle+ '" id="' +buttonID+ '" class="button" unselectable="on" width="20" height="20"></td>';
				}
				else
				{
  	...
  	var toolbar2;
  	toolbar2 = '<table  id="TabelaEditor2" cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:' + toolbarWidth + 'px; display: none;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
  ...
  var iframe = '<table  id="TabelaEditor3" cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px inset #CCCCCC;"><tr><td valign="top">\n'
  ...
  outputFontSelect(n,$bln_noFontes);
  outputFontSizes(n,$bln_noFontes); 
...
function formatText(id, n, selected) 
{
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	{
	  alertMenssage ('Atenção:','Você está no modo HTML. Este recurso e desativado neste modo.');
	}
...
\* ---------------------------------------------------------------------- */
function outputFontSelect(n, $bln_noFontes) {
  ...
  var FontSelectOn         = FontSelectObj[3];
	...
	$onclick = "showFonts('"+n+"' , "+$bln_noFontes+");";
	FontSelectDropDown[n] = '<table border="0" cellpadding="0" cellspacing="0"><tr><td onMouseOver="document.getElementById(\'selectFont' + n + '\').src=\'' + FontSelectOn + '\';" onMouseOut="document.getElementById(\'selectFont' + n + '\').src=\'' + FontSelect + '\';"><img src="' + FontSelect + '" id="selectFont' + n + '" width="85" height="20" onClick="'+$onclick+'" unselectable="on"><br>';
...
/* ---------------------------------------------------------------------- *\
  ...
  Arguments   : n   - The editor identifier that the Font Sizes will update
	                    when making font changes (the textarea's ID)
\* ---------------------------------------------------------------------- */
function outputFontSizes(n, $bln_noFontes) {
  ...
  var FontSizeOn         = FontSizeObj[3];
	...
	$onclick = "showFontSizes('"+n+"' , "+$bln_noFontes+");";
	FontSizesDropDown[n] = '<table border="0" cellpadding="0" cellspacing="0"><tr><td onMouseOver="document.getElementById(\'selectSize' + n + '\').src=\'' + FontSizeOn + '\';" onMouseOut="document.getElementById(\'selectSize' + n + '\').src=\'' + FontSize + '\';"><img src="' + FontSize + '" id="selectSize' + n + '" width="49" height="20" onClick="'+$onclick+'" unselectable="on"><br>';
...
/* ---------------------------------------------------------------------- *\
  ...
  Arguments   : n   - The editor identifier (the textarea's ID)
\* ---------------------------------------------------------------------- */
function showFonts(n,$bln_noFontes) { 
...
/* ---------------------------------------------------------------------- *\
  ...
  Arguments   : n   - The editor identifier (the textarea's ID)
\* ---------------------------------------------------------------------- */
function showFontSizes(n,$bln_noFontes) { 
