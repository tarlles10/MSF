				...
				if (this.isAbsoluteInside(x,y)){
					if (this.link)
						if (this.target){			
							...
							if (this.link=='googleMaps')
							{
								//Biblioteco GreyBox
								GB_showCenter('Localize no mapa abaixo a posição do Imóvel', 'http://maps.google.com.br/maps/empw?url=http:%2F%2Fmaps.google.com.br%2F%3Fie%3DUTF8%26ll%3D-12.46876,-53.085937%26spn%3D0.003675,0.004989%26t%3Dh%26z%3D4%26output%3Dembed%26s%3DAARTsJqzARj-Z8VnW5pkPMLMmZbqrJcYpw&hl=pt-BR&gl=br');							
							}else
							{
								menuConcatenacaoStringsParametro(this.link, 10);
							}
