...
<table width="579" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td class="top_grupoRes_top_02" style="width: 286px;"><a href='<?php echo $objRssFeed->getAdicionarFeedRss(TRUE);?>' target='<?php echo $objRssFeed->getOndeAbriJanela();?>' class="adm_fonteResTop_01" title="Clique Aqui para Assinar">Assine Nosso <span style="color: #ff7707;">Feed RSS</span></a></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="457" height="70" align="left" valign="top">
                	<span class="adm_fonteFormGrupo_01" style="color: #999999;"><?php echo $objRssFeed->getDt_publicacao();?></span>
                    <div class="adm_fonteResTop_04"><?php echo $objRssFeed->getTituloItem();?></div>
                </td>
                <td width="170"></td>
              </tr>
              <tr>
              	<td></td>
                <td colspan="2" align="left" valign="top" class="adm_fonteTextoGrupo_01" id="descricaoTexto"><?php echo $objRssFeed->getDescricaoItem();?></td>
              </tr>
              <tr>
              	<td></td>
                <td colspan="2" align="center" valign="top" class="adm_fonteResTop_04"><?php echo $objRssFeed->getMsgErro();?></td>
              </tr>
            </table>
        </td>
		<td class="med_grupoRes_D"></td>
