...
<meta name="Generator" content="<?php echo $objConfiguracao->showTitulo().' :: '.$dadosboleto["identificacao"]?>" />
...
#instr_header {
	background: url('<?php echo $objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/logo_empresa.png';?>') no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
do Sacado</b></div></TD></tr></tbody></table>
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="<?php echo $objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/logobb.jpg';?>"></td>
			<td width=50>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD width=666 align=right ><font style="font-size: 10px;">Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensação</font></TD></tr></tbody></table>
		<div class="barcode">
			<p><?php echo fbarcode($dadosboleto["codigo_barras"],$objConfiguracao); ?></p>
		</div>
		<div class="cut">
			<p>Corte na linha pontilhada</p>
		</div>
