<?php // +----------------------------------------------------------------------+
	...
	function fbarcode($valor,$objConfiguracao) 
	{
	...
	//Guarda inicial
	$str_codigoBarraRetorno = '<img src='.$objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/p.png width='.$fino.' height='.$altura.' border=0><img 
	src='.$objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/b.png width='.$fino.' height='.$altura.' border=0><img 
	src='.$objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/p.png width='.$fino.' height='.$altura.' border=0><img 
	src='.$objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/b.png width='.$fino.' height='.$altura.' border=0><img ';
	...
	while (strlen($texto) > 0) 
	{
	  ...
	  for($i=1;$i<11;$i+=2) 
	  {
		...
		$str_codigoBarraRetorno .= ' src='.$objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/p.png width='.$f1.' height='.$altura.' border=0><img ';
		...
		$str_codigoBarraRetorno .= ' src='.$objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/b.png width='.$f2.' height='.$altura.' border=0><img ';
	  }
	}
	
	// Draw guarda final
	
	$str_codigoBarraRetorno .= 'src='.$objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/p.png width='.$largo.' height='.$altura.' border=0><img 
	src='.$objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/b.png width='.$fino.' height='.$altura.' border=0><img 
	src='.$objConfiguracao->getDiretorioConcateEmail().'/adm/boleto_imagens/p.png width=1 height='.$altura.' border=0>';
	
	return $str_codigoBarraRetorno;
	} //Fim da função
