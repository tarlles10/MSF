<?php header("Content-Type: text/html; charset=ISO-8859-1",true);
	...
	if (isset($_POST["id_municipio"]) || !empty($_POST["id_municipio"]))
	{
		...
		{
			$combo = '<select name="slc_bairro" id="*" class="adm_formResCombo_01" style="width:125" title="Bairro" ><option value="">:: selecione ::</option>';
		...
		{
			$combo = '<select name="slc_bairro" id="*" class="adm_formResCombo_01" style="width:125" title="Bairro" >';
