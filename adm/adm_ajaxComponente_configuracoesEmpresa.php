<?php header("Content-Type: text/html; charset=ISO-8859-1",true);
	...
	//============================================================================//
	//      			Tratamento Especifico do Formulário        				  //
	//============================================================================//
...
<script>
	function atribuirValoresFormulario($str_acao)
	{
		...
		if ($str_acao == 'Excluir')
		{
			if(!(confirm("Atenção: \nEsta ação excluirá este dado Institucional.\nClique em OK se deseja continuar.")))
			{
				$continuaAcao = false;
			}
		}
              ...
              <tr>
                ...
                <!-- inicio tabela campo Data -->
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="30"><input name="str_dtPublicacao" id="str_dtPublicacao" type="text" class="adm_formGrupoTxt_01" style="width: 70px;" maxlength="10" value="<?php echo $objEmpresa->dt_publicacao;?>" OnKeyPress="formataMascara('##/##/####', this); return retornaNumeros(event,this);" onblur="verificaData(this);" title="Data Publicação"></td>
