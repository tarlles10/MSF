...
<script>
	function atribuirValoresFormulario($str_acao, $diretorioDestino)
	{
		...
		if ($str_acao == 'Excluir')
		{
			if(!(confirm("Atenção: \nEsta ação excluirá todas as informações deste molde.\nClique em OK se deseja continuar.")))
			{
				$continuaAcao = false;
			}
		}
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="adm_fonteFormGrupo_01">
              ...
              <tr>
                ...
                <td align="left"><input name="int_posicaox" id="*" type="text" class="adm_formGrupoTxt_01" style="width:25;" maxlength="3" value="<?php echo $objMoldes->int_posicaox;?>"  OnKeyPress="return retornaNumeros(event,this);" title="Posição X" ></td>
                <td colspan="2" align="right">Posi&ccedil;&atilde;o Y:&nbsp;</td>
                <td colspan="3" align="left"><input name="int_posicaoy" id="*" type="text" class="adm_formGrupoTxt_01" style="width:25;" maxlength="3" value="<?php echo $objMoldes->int_posicaoy;?>"  OnKeyPress="return retornaNumeros(event,this);" title="Posição Y" ></td>
              </tr>
              <tr>
                <td colspan="7" height="12"></td>
              </tr>
              <tr>
                ...
                <td align="left"><input name="int_posicaogx" id="*" type="text" class="adm_formGrupoTxt_01" style="width:25;" maxlength="3" value="<?php echo $objMoldes->int_posicaogx;?>"  OnKeyPress="return retornaNumeros(event,this);" title="Posição GX" ></td>
                <td colspan="2" align="right">Posi&ccedil;&atilde;o GY:&nbsp;</td>
                <td colspan="3" align="left"><input name="int_posicaogy" id="*" type="text" class="adm_formGrupoTxt_01" style="width:25;" maxlength="3" value="<?php echo $objMoldes->int_posicaogy;?>" OnKeyPress="return retornaNumeros(event,this);" title="Posição GY" ></td>
              </tr>
              <tr>
                <td colspan="7" height="12"></td>
              </tr>
