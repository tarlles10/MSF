<?php header("Content-Type: text/html; charset=ISO-8859-1",true);
	...
	if (isset($_POST["str_tipoImovel"]) || !empty($_POST["str_tipoImovel"]))
	{
		if ($_POST["str_tipoImovel"] != '')
		{
			...
			$combo = '<select name="slc_subTipoImovel" id="slc_subTipoImovel" class="adm_formResCombo_01" style="width:127">';
		...
		}else
		{
			...
			$combo .= '<option title="selecione o Tipo de Imóvel" value="">:: selecione o Tipo de Imóvel ::</option>';
			$combo .= '</select>';		
		}
		echo $combo;
	}
